...
var form = document.querySelector("#bindecform");
var buttonToBin = document.querySelector('#button_TO_BIN');
var buttonToDec = document.querySelector('#button_TO_DEC');
var strDec = document.querySelector('#num_dec');
var strBin = document.querySelector('#num_bin');
...
function completeTo8(strBinOct) {
  ...
  console.log(zerosToAdd); //console.log(strBinOct.length)
...
function ipDecToBin(ipDec) {
  ...
  var octsBin = [];
  var ipBin = '';
  octsDec.forEach(function (element) {
...
function ipBinToDec(ipBin) {
  ...
  var octsDec = [];
  var ipDec = '';
  octsBin.forEach(function (element) {
...
function getOcts(ip) {
  var arrayOcts = ip.split('.');
  return arrayOcts;
}

function getBin() {
  var ipBin = ipDecToBin(strDec.value);
  strBin.value = ipBin;
}

function getDec() {
  var ipDec = ipBinToDec(strBin.value);
  strDec.value = ipDec;
